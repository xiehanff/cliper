...
class MacOSViewportService implements ViewportController {
  ...
  MacOSViewportService({required AppLogger logger}) : _logger = logger;
  ...
  Future<void> initialize() async {
    ...
    _logger.info('macOS viewport initialized');
  }
...
class _ViewportListener extends WindowListener {
  final MacOSViewportService _service;
